...
let weather = {
  apiKey: "", //API KEY IS PRIVATE ( NOT DISCLOSED HERE, APP IS FUNCTIONAL ONLY WITH THE HELP OF KEY)
...
let geocode = {
  ...
  reverseGeocode:function(latitude,longitude){
    var api_key = '';//API KEY IS PRIVATE ( NOT DISCLOSED HERE, APP IS FUNCTIONAL ONLY WITH THE HELP OF KEY)
